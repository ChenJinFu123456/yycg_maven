...
var columns = [ [{
	...
	formatter: function(value,row,index){
		return '<input type="hidden" name="gysypmlCustoms['+index+'].gysypmlid" value="'+row.gysypmlid+'" />';
	}
},{
	field : 'usergysmc',
	title : '供货企业',
	...
	formatter : function (value,row,index){
		return '<select  name="gysypmlCustoms['+index+'].control" style="width:80px">'
	...
	formatter : function (value,row,index){
		...
		//var val = value?value:"";
		return '<input type="text" name="gysypmlCustoms['+index+'].advice" value="'+val+'" />';
	}
},{
	field : 'bm',
	title : '流水号',
					...
					<tr>
						...
						<td >
						 ...
						 <td class="left" height="25">供货商：</td>
				  		<td>
				  		<input type="text" name="usergys.mc" id="usergysCustom.mc" />
